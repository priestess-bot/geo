...
from geo_core.runtime import RuntimePersistenceError, build_repository_from_env, close_repository_connection
from geo_core.auth import AUTH_SURFACE_POLICY_VERSION, RUNTIME_SESSION_SCOPE_VERSION, InvitationSurface
...
def register_runtime_access_routes(
    ...
    *,
    ...
    def runtime_projects_with_surface_projection(
        ...
        context = resolve_auth_context(x_geo_actor_id) if callable(resolve_auth_context) else None
        try:
