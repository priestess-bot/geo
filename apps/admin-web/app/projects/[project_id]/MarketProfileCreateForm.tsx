  ...
  return (
    <form action={action} className={styles.form}>
      ...
      <div className={styles.formGrid}>
        ...
        <label><span>Locale</span><input name="locale" placeholder="en-AU" required /></label>
        <label><span>Timezone</span><input name="timezone" placeholder="Australia/Sydney" required /></label>
