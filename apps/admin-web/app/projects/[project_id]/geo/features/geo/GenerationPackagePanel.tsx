  ...
  return <div className={styles.workspace}>
    ...
    <div className={styles.columns}>
      ...
      <section className={styles.workspace}>
        <div className={styles.panel}><div className={styles.sectionHeader}><div><p>制作者与复核者分离</p><h2>提交与独立审核</h2></div></div><ActionForm action={submitPackageReview} submitLabel="提交独立审核" disabled={!version}><HiddenProject projectId={projectId} /><input type="hidden" name="campaign_id" value={data.selection.campaignId || ""} /><input type="hidden" name="version_id" value={version?.id || ""} /></ActionForm>
