...
class AdminCustomerWebContractsTest(unittest.TestCase):
    ...
    def test_admin_project_detail_wires_customer_access_runtime_actions(self) -> None:
        ...
        self.assertIn("/v1/knowledge-facts/runtime/import.csv", action_source)
        ...
        self.assertIn("KnowledgeFactImportForm", page_source)
        self.assertIn("/v1/knowledge-facts/runtime/search", page_source)
        self.assertIn("?tab=knowledge&knowledge_tab=search", action_source)
        self.assertIn("知识库检索", page_source)
        self.assertIn("导入知识事实 CSV", component_source)
        self.assertIn("fact_type,subject,predicate,object_value", component_source)
        ...
        self.assertIn("/v1/content-drafts/runtime/", action_source)
        ...
        self.assertIn("Unstructured 默认", component_source)
