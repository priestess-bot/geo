...
def _gate_no_fixture_production() -> list[Check]:
    ...
    checks.extend(
        [
            ...
            _check_contains(
                ...
                "apps/api/geo_api/runtime_access_routes.py",
                'collection_mode: str = Field(default="api"',
            ),
            _check_contains(
    ...
    forbidden_by_file = {
        ...
        "packages/geo_core/geo_core/models.py": (
...
def _gate_no_secret_leak() -> list[Check]:
    checks = _gate_checklist()
    forbidden_literals = (
        "geo-invite-d3536f6cb7bd448eabdeebe08d6bac92",
        "openai-secret",
        "perplexity-secret",
        "pplx-",
        "AIza",
    ...
    checks.append(_check_contains("connector_secret_store_adapter_exists", "packages/geo_core/geo_core/security/secrets.py", "def encrypt_connector_secret"))
    checks.append(_check_contains("connector_secret_api_exists", "apps/api/geo_api/main.py", "/v1/connectors/runtime/secrets"))
    checks.append(_check_contains("access_log_redacts_secret_body", "apps/api/geo_api/access_logging.py", "redact_secret_text"))
...
def _gate_report_traceability() -> list[Check]:
    return [
        *_gate_checklist(),
        _check_contains("report_mentions_traceability_chain", "packages/geo_core/geo_core/report.py", "ReportExport -> VisibilityScoreSnapshot -> ScoreContribution"),
        _check_contains("traceability_module_exists", "packages/geo_core/geo_core/traceability.py", "TraceabilityBundle"),
        ...
        _check_contains("runtime_evidence_asset_input_model_exists", "packages/geo_core/geo_core/models.py", "class RuntimeEvidenceAssetInput"),
        _check_contains("runtime_evidence_asset_model_exists", "packages/geo_core/geo_core/models.py", "class RuntimeEvidenceAsset"),
        _check_contains("evidence_asset_repository_method_exists", "packages/geo_core/geo_core/repository.py", "def save_runtime_evidence_asset"),
        _check_contains("raw_evidence_records_write_scoped_assets", "packages/geo_core/geo_core/repository.py", "JOIN projects p ON p.id = ar.project_id"),
        _check_contains("evidence_created_audit_exists", "packages/geo_core/geo_core/repository.py", "event_type=\"evidence.created\""),
        _check_contains("s3_compatible_store_exists", "packages/geo_core/geo_core/object_store.py", "class S3CompatibleObjectStore"),
        _check_contains("object_store_download_exists", "packages/geo_core/geo_core/object_store.py", "def get_object"),
        _check_contains("object_store_hash_mismatch_rejected", "packages/geo_core/geo_core/object_store.py", "Object content hash mismatch"),
        _check_contains("archive_evidence_bytes_exists", "packages/geo_core/geo_core/object_store.py", "def archive_evidence_bytes"),
        ...
        _check_contains("report_traceability_smoke_exists", "packages/geo_core/geo_core/traceability.py", "def verify_report_traceability_smoke"),
        _check_contains("report_traceability_smoke_result_exists", "packages/geo_core/geo_core/traceability.py", "class ReportTraceabilitySmokeResult"),
        ...
        _check_contains("analysis_output_contract_exists", "packages/geo_core/geo_core/analysis_contract.py", "def build_answer_analysis_output_contract"),
        _check_contains("analysis_human_override_exists", "packages/geo_core/geo_core/analysis_contract.py", "def apply_human_review_override"),
        ...
        _check_contains("production_v1_formula_exists", "packages/geo_core/geo_core/scoring.py", "visibility_v1.0"),
        _check_contains("production_v1_formula_weights_exist", "packages/geo_core/geo_core/scoring.py", "VISIBILITY_V1_0"),
        ...
        _check_contains("report_export_schema_exists", "packages/geo_core/geo_core/models.py", "class ReportExport"),
        _check_contains("report_export_repository_insert_is_immutable", "packages/geo_core/geo_core/repository.py", "ON CONFLICT (id) DO NOTHING"),
        ...
        _check_contains("report_markdown_generation_exists", "packages/geo_core/geo_core/report.py", "def _build_markdown_report"),
        _check_contains("report_csv_generation_exists", "packages/geo_core/geo_core/report.py", "def _build_csv_evidence"),
        _check_contains("report_pdf_generation_exists", "packages/geo_core/geo_core/report.py", "def render_markdown_pdf"),
        _check_contains("report_artifact_archive_exists", "packages/geo_core/geo_core/object_store.py", "def archive_report_artifacts"),
...
def _gate_customer_access_negative() -> list[Check]:
    return [
        *_gate_checklist(),
        ...
        _check_contains("artifact_route_reads_session_cookie", "apps/customer-web/app/api/report-artifact/route.ts", "GEO_RUNTIME_SESSION"),
        _check_contains("artifact_route_uses_session_header", "apps/customer-web/app/api/report-artifact/route.ts", "X-GEO-Session-Token"),
        ...
        _check_absent("artifact_route_avoids_actor_header_impersonation", "apps/customer-web/app/api/report-artifact/route.ts", "X-GEO-Actor-Id"),
        _check_contains("artifact_route_marks_customer_portal_access", "apps/customer-web/app/api/report-artifact/route.ts", "X-GEO-Customer-Portal-Access"),
        ...
        _check_contains("report_management_status_aliases_api", "apps/api/geo_api/main.py", "REPORT_MANAGEMENT_STATUS_ALIASES"),
        _check_contains("report_management_status_aliases_repository", "packages/geo_core/geo_core/repository.py", "REPORT_MANAGEMENT_STATUS_ALIASES"),
        ...
        _check_contains("report_artifact_checks_latest_management_status", "apps/api/geo_api/main.py", "get_report_export_latest_management_status"),
        _check_contains("report_artifact_requires_client_ready_for_customers", "apps/api/geo_api/main.py", "CUSTOMER_PORTAL_REPORT_READY_STATUS"),
        ...
        _check_contains("evidence_asset_summary_endpoint_exists", "apps/api/geo_api/main.py", "/v1/evidence-assets/runtime/{evidence_asset_id}/summary"),
        _check_contains("evidence_asset_download_endpoint_exists", "apps/api/geo_api/main.py", "/v1/evidence-assets/runtime/{evidence_asset_id}/download"),
        ...
        _check_contains("evidence_download_uses_object_store_proxy", "apps/api/geo_api/main.py", "X-GEO-Evidence-Asset-Proxy"),
    ]
...
def _gate_security() -> list[Check]:
    checks = [
        ...
        *_gate_rls(),
        _check_contains("auth_context_contract_exists", "apps/api/geo_api/auth_context.py", "class AuthContext"),
        _check_contains("auth_context_has_required_scope_fields", "apps/api/geo_api/auth_context.py", "project_ids: tuple[str, ...]"),
        _check_contains("system_actor_requires_scope", "apps/api/geo_api/auth_context.py", "allow_unscoped"),
        _check_contains("auth_audit_event_vocabulary_exists", "packages/geo_core/geo_core/audit.py", "AUTH_AUDIT_EVENT_TYPES"),
        _check_contains("auth_audit_rejects_raw_secret_refs", "packages/geo_core/geo_core/audit.py", "AUTH_AUDIT_FORBIDDEN_REF_KEYS"),
        _check_contains("runtime_auth_context_dependency_exists", "apps/api/geo_api/main.py", "def build_runtime_auth_context"),
        ...
        _check_contains("runtime_session_repository_exists", "packages/geo_core/geo_core/runtime_project_access_repository.py", "def create_runtime_session"),
        _check_contains("rbac_permission_vocabulary_exists", "packages/geo_core/geo_core/rbac.py", "PERMISSION_VOCABULARY"),
        _check_contains("rbac_role_matrix_exists", "packages/geo_core/geo_core/rbac.py", "ROLE_PERMISSION_MATRIX"),
        _check_contains("rbac_declares_report_download", "packages/geo_core/geo_core/rbac.py", "\"report.download\""),
        _check_contains("rbac_declares_connector_secret_manage", "packages/geo_core/geo_core/rbac.py", "\"connector.secret.manage\""),
        ...
        _check_contains("membership_scope_repository_exists", "packages/geo_core/geo_core/runtime_project_access_repository.py", "def get_runtime_membership_scope"),
        _check_contains("session_auth_mode_exists", "apps/api/geo_api/main.py", "RUNTIME_AUTH_MODE_SESSION"),
        _check_contains("session_cookie_name_exists", "apps/api/geo_api/main.py", "GEO_RUNTIME_SESSION"),
        _check_contains("protected_api_uses_auth_context_project_scope", "apps/api/geo_api/main.py", "def _assert_auth_context_project_access"),
        _check_contains("invitation_redeem_endpoint_exists", "apps/api/geo_api/main.py", "@app.post(\"/v1/auth/invitations/redeem\")"),
        _check_contains("auth_me_endpoint_exists", "apps/api/geo_api/main.py", "@app.get(\"/v1/auth/me\")"),
        _check_contains("auth_logout_endpoint_exists", "apps/api/geo_api/main.py", "@app.post(\"/v1/auth/logout\")"),
        _check_contains("runtime_session_cookie_is_httponly", "apps/api/geo_api/main.py", "httponly=True"),
        _check_regex("jwt_or_jwks_auth_exists", "apps/api/geo_api/main.py", r"RUNTIME_AUTH_MODE_ENV|jwks|JWT"),
        _check_contains("csrf_header_contract_exists", "apps/api/geo_api/main.py", "X-GEO-CSRF-Token"),
        _check_contains("csrf_cookie_contract_exists", "apps/api/geo_api/main.py", "GEO_CSRF_TOKEN"),
        _check_contains("csrf_enforced_for_session_mutations", "apps/api/geo_api/main.py", "def _assert_runtime_session_csrf"),
    ...
    checks = [
        *_gate_checklist(),
        _check_contains(
            ...
            "packages/geo_core/geo_core/connector_contract.py",
        ...
        _check_contains("openai_collector_exists", "packages/geo_core/geo_core/collectors.py", "class OpenAIWebSearchCollector"),
        _check_contains("openai_responses_endpoint", "packages/geo_core/geo_core/collectors.py", "https://api.openai.com/v1/responses"),
        _check_contains(
        ...
        _check_contains("perplexity_collector_exists", "packages/geo_core/geo_core/collectors.py", "class PerplexitySonarCollector"),
        _check_contains(
        ...
        _check_contains("google_manual_backfill_exists", "apps/api/geo_api/main.py", "/v1/evidence-runs/runtime/manual-backfill"),
        _check_contains(
...
def _gate_ops() -> list[Check]:
    return [
        *_gate_checklist(),
        _check_contains("ops_router_registered", "apps/api/geo_api/main.py", "register_ops_routes(app)"),
        _check_contains("health_endpoint_exists", "apps/api/geo_api/ops_routes.py", "@router.get(\"/health\")"),
        _check_contains("ready_endpoint_exists", "apps/api/geo_api/ops_routes.py", "@router.get(\"/ready\")"),
        _check_contains("metrics_endpoint_exists", "apps/api/geo_api/ops_routes.py", "@router.get(\"/metrics\")"),
        _check_contains("runtime_metrics_middleware_exists", "apps/api/geo_api/main.py", "runtime_metrics_middleware"),
        ...
        _check_contains("runtime_alert_api_exists", "apps/api/geo_api/main.py", "/v1/runtime-alerts"),
...
def _gate_official_ui_contract() -> list[Check]:
    ...
    checks = [
        *_gate_checklist(),
        ...
        _check_contains("api_content_draft_review_endpoint_exists", "apps/api/geo_api/main.py", "/v1/knowledge/content-drafts/runtime/{content_draft_id}/review"),
        _check_contains("api_distribution_backfill_endpoint_exists", "apps/api/geo_api/main.py", "/v1/manual-distribution-records/runtime/{distribution_record_id}/backfill"),
...
def _gate_production_e2e() -> list[Check]:
    ...
    return [
        *_gate_checklist(),
        ...
        _check_contains("action_plan_p0_action_types_exist", "packages/geo_core/geo_core/action_plan.py", "ACTION_PLAN_P0_ACTION_TYPES"),
        ...
        _check_contains("action_model_customer_visible_default", "packages/geo_core/geo_core/models.py", "customer_visible: bool = False"),
        _check_contains("action_model_score_contribution_links", "packages/geo_core/geo_core/models.py", "score_contribution_ids: tuple[str, ...] = ()"),
        ...
        _check_contains("action_repository_persists_customer_visibility", "packages/geo_core/geo_core/repository.py", "customer_visible"),
        ...
        _check_contains("retest_comparison_audit_exists", "packages/geo_core/geo_core/action_plan.py", "retest_comparison_created"),
...
def _gate_enablement_e2e() -> list[Check]:
    return [
        *_gate_checklist(),
        _check_contains("knowledge_module_exists", "packages/geo_core/geo_core/knowledge.py", "build_localized_knowledge_facts"),
        _check_contains("knowledge_approved_status_contract_exists", "packages/geo_core/geo_core/knowledge.py", "KNOWLEDGE_FACT_APPROVED_STATUS"),
        _check_contains("knowledge_search_filters_approved_only", "packages/geo_core/geo_core/knowledge.py", "fact.status != KNOWLEDGE_FACT_APPROVED_STATUS"),
        _check_contains("runtime_knowledge_search_filters_approved_only", "packages/geo_core/geo_core/repository.py", "KNOWLEDGE_FACT_APPROVED_STATUS"),
        _check_contains("runtime_knowledge_search_api_exists", "apps/api/geo_api/main.py", "def runtime_knowledge_fact_search"),
        _check_contains("content_drafts_model_exists", "packages/geo_core/geo_core/models.py", "class ContentDraft"),
        _check_contains("content_review_pending_contract_exists", "packages/geo_core/geo_core/knowledge.py", "CONTENT_REVIEW_PENDING_STATUS"),
        _check_contains("runtime_content_engines_api_exists", "apps/api/geo_api/main.py", "def runtime_content_engines"),
        _check_contains("runtime_content_export_api_exists", "apps/api/geo_api/main.py", "def runtime_content_engines_export_csv"),
        _check_contains("distribution_model_exists", "packages/geo_core/geo_core/models.py", "class ManualDistributionRecord"),
        _check_contains(
            "manual_distribution_backfill_contract_exists",
            "packages/geo_core/geo_core/knowledge.py",
        ...
        _check_contains("knowledge_pipeline_repository_exists", "packages/geo_core/geo_core/knowledge_pipeline.py", "class KnowledgePipelineRepository"),
        _check_contains("knowledge_pipeline_api_exists", "apps/api/geo_api/main.py", "/v1/knowledge/pipeline-runs/runtime"),
...
def _gate_knowledge_application() -> list[Check]:
    return [
        *_gate_checklist(),
        ...
        _check_contains("knowledge_url_private_network_guard_exists", "packages/geo_core/geo_core/knowledge_application.py", "blocked_private_network"),
        ...
        _check_contains("knowledge_deepseek_default_model_exists", "packages/geo_core/geo_core/knowledge_application.py", "deepseek-v4-flash"),
        _check_contains("knowledge_deepseek_extract_adapter_exists", "packages/geo_core/geo_core/knowledge_application.py", "def deepseek_extract_knowledge_facts"),
        _check_contains("knowledge_deepseek_generate_adapter_exists", "packages/geo_core/geo_core/knowledge_application.py", "def deepseek_generate_knowledge_application"),
        _check_contains("knowledge_deepseek_key_file_fallback_exists", "packages/geo_core/geo_core/knowledge_application.py", "deepseek_api_key.txt"),
        _check_contains("knowledge_pipeline_repository_exists", "packages/geo_core/geo_core/knowledge_pipeline.py", "class KnowledgePipelineRepository"),
        _check_contains("knowledge_pipeline_idempotent_start_exists", "packages/geo_core/geo_core/knowledge_pipeline.py", "create a versioned rerun"),
        ...
        _check_contains("knowledge_pipeline_api_create_exists", "apps/api/geo_api/main.py", "/v1/knowledge/pipeline-runs/runtime"),
        _check_contains("knowledge_import_file_api_exists", "apps/api/geo_api/main.py", "/v1/knowledge/import-jobs/runtime/{import_job_id}/files"),
        _check_contains("knowledge_quality_api_exists", "apps/api/geo_api/main.py", "/v1/knowledge/quality-gate-runs/runtime"),
        _check_contains("knowledge_prompt_api_exists", "apps/api/geo_api/main.py", "/v1/knowledge/prompt-generation-jobs/runtime"),
        _check_contains("knowledge_content_api_exists", "apps/api/geo_api/main.py", "/v1/knowledge/content-generation-jobs/runtime"),
