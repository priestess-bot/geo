...
def verify_au_handoff_dossier(
    ...
    *,
    ...
    if summary.get("p0b_google_environment_handoff_ready") is not p0b_google_execution_checklist.get(
        "environment_handoff_ready"
    ):
        errors.append("summary_p0b_google_environment_handoff_ready_mismatch")
    if summary.get("p0b_google_environment_handoff_missing_required_count") != p0b_google_execution_checklist.get(
        "environment_handoff_missing_required_count"
    ):
        errors.append("summary_p0b_google_environment_handoff_missing_required_count_mismatch")
    if summary.get("p0b_google_environment_handoff_secret_redacted") is not p0b_google_execution_checklist.get(
    ...
    if endpoints.get("external_dependency_clearance") != "GET /v1/external-dependency-clearance/au":
        errors.append("runtime_endpoint_external_dependency_clearance_invalid")
