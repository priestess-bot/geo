...
OUTPUT_PATH_KEYS = (
    "GENO_AU_P0B_GOOGLE_RUNBOOK_OUTPUT_PATH",
    "GENO_AU_P0B_GOOGLE_RUNBOOK_EXECUTION_OUTPUT_PATH",
    "GENO_AU_P0B_GOOGLE_PLAYWRIGHT_ENV_OUTPUT_PATH",
    "GENO_AU_P0B_GOOGLE_PLAYWRIGHT_SMOKE_OUTPUT_PATH",
    "GENO_AU_P0B_GOOGLE_MANUAL_BACKFILL_TEMPLATE_PATH",
    "GENO_AU_P0B_GOOGLE_MANUAL_BACKFILL_TEMPLATE_MANIFEST_PATH",
    "GENO_AU_P0B_GOOGLE_MANUAL_BACKFILL_VERIFICATION_PATH",
    "GENO_AU_P0B_GOOGLE_STATUS_OUTPUT_PATH",
)
