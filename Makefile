...
au-launch-status:
	PYTHONPATH=packages/geno_core:apps/api python3 scripts/build_au_launch_status.py --p0a-status-path $${GENO_AU_P0A_STATUS_OUTPUT_PATH:-docs/runtime_preflight/au-p0a-status-latest.json} --p0b-google-status-path $${GENO_AU_P0B_GOOGLE_STATUS_OUTPUT_PATH:-docs/runtime_preflight/au-p0b-google-spike-status-latest.json} --p0b-google-package-path $${GENO_AU_P0B_GOOGLE_PACKAGE_OUTPUT_PATH:-docs/runtime_preflight/au-p0b-google-evidence-package-latest.json} --p0b-google-runbook-path $${GENO_AU_P0B_GOOGLE_RUNBOOK_OUTPUT_PATH:-docs/runtime_preflight/au-p0b-google-spike-runbook-latest.json} --p0b-google-execution-path $${GENO_AU_P0B_GOOGLE_RUNBOOK_EXECUTION_OUTPUT_PATH:-docs/runtime_preflight/au-p0b-google-spike-runbook-execution-latest.json} --output-path $${GENO_AU_LAUNCH_STATUS_OUTPUT_PATH:-docs/runtime_preflight/au-launch-status-latest.json}
