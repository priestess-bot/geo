...
默认地址：API `http://localhost:8000/health`，控制台 `http://localhost:3000`。控制台会读取 runtime evidence / score / graph / report / action / content API；如果还没有数据，先运行 worker profile 写入一批 fixture runtime 数据。
