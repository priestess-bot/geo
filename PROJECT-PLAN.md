...
- `[~]` (P0c) 监测看板：总览/平台对比/竞品对比/问题明细/风险 — `E5-01..05`（Runtime Console 已展示 Project Bootstrap、Runtime Filters、Prompt Pack、Evidence Runs 明细、Score Contributions 完整解释包、Citation Graph & Competitors 明细、Citation Graph Map、source gaps、actions、Runtime Alerts、Content Engine Detail、Traceability Detail、Traceability Map、节点级 details 钻取和页面内锚点深链路；完整问题明细 UI 待接）
