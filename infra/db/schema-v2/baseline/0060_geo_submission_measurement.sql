...
CREATE FUNCTION geno_v2_reject_observed_destination_submission()
...
CREATE TRIGGER placement_submissions_destination_guard
    ...
    EXECUTE FUNCTION geno_v2_reject_observed_destination_submission();
...
ALTER FUNCTION geno_v2_reject_observed_destination_submission() OWNER TO geno_v2_result_owner;
...
REVOKE ALL ON FUNCTION geno_v2_reject_observed_destination_submission() FROM PUBLIC;
