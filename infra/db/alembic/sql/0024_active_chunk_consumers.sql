    ...
    SELECT
        ...
        AND NOT EXISTS (
            ...
            LEFT JOIN knowledge_chunks AS chunk
              ON chunk.id = input.chunk_id
             AND chunk.project_id = input.project_id
            ...
            WHERE source.candidate_id = target_candidate_id
              AND (
                  ...
                  OR chunk.id IS NULL OR chunk.status <> 'active'
              ...
              AND (
                  ...
                  OR NOT EXISTS (
                      ...
                      JOIN knowledge_chunks AS chunk
                       ...
                       AND chunk.source_id = lineage.source_id
                       AND chunk.document_id = lineage.document_id
