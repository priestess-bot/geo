-- A durable_jobs update for an unrelated domain must not require Synthetic scope.
-- Once a Synthetic child link exists, preserve the original fail-closed scope guard.
