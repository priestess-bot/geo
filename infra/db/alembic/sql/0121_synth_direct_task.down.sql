...
BEGIN
    IF EXISTS (
        ...
        WHERE task_type = 'geo_core.synthetic_lab.execution_contracts.DirectGenerationTask'
    ) THEN
        RAISE EXCEPTION 'cannot downgrade direct Synthetic generation while evidence exists';
    END IF;
END;
$$;
