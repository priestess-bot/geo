-- Restore the pre-repair transition contract. Existing immutable revisions and
-- QuestionSet versions remain readable; only new rejected-to-pending repairs stop.
