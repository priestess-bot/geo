...
class SchemaV2SessionTokenHashError(SchemaV2SessionUnitOfWorkError):
    def __init__(self) -> None:
        super().__init__(
            ...
            "session_token_hash must be a 64-character lowercase SHA-256 value",
        )
...
class SchemaV2ApiSessionUnitOfWork:
    ...
    def __init__(
        ...
        *,
        ...
        if not isinstance(session_token_hash, str) or not SESSION_TOKEN_HASH_PATTERN.fullmatch(
            session_token_hash
        ):
        ...
        self._session_token_hash: str | None = session_token_hash
        ...
        try:
            with self._connection.cursor() as cursor:
                ...
                cursor.execute(
                    ...
                    FROM public.geno_v2_resolve_session_context()
                    """
                )
    ...
    def __exit__(self, exc_type: object, exc: object, traceback: object) -> bool:
        ...
        if completion_failed or cleanup_failed:
        ...
        if completion_failed:
            raise SchemaV2SessionUnitOfWorkError(
                "session_transaction_completion_failed",
                "Schema v2 session transaction could not be completed",
            ) from None
        if cleanup_failed:
            raise SchemaV2SessionUnitOfWorkError(
