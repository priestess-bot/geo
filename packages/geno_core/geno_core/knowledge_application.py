...
from geno_core.knowledge import CONTENT_REVIEW_PENDING_STATUS, KNOWLEDGE_FACT_APPROVED_STATUS
...
DEEPSEEK_API_KEY_FILE_ENV = "GENO_DEEPSEEK_API_KEY_FILE"
...
def stable_knowledge_id(kind: str, *parts: object) -> str:
    ...
    return str(uuid5(NAMESPACE_URL, f"geno:{kind}:{payload}"))
