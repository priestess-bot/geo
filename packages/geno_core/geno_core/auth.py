...
from geno_core.models import RuntimeProjectSessionScope, RuntimeSessionScopeV2
...
class AuthSessionV2Repository:
    def __init__(
        ...
        *,
        ...
        session_cookie_name: str = "GENO_RUNTIME_SESSION",
        csrf_cookie_name: str = "GENO_CSRF_TOKEN",
        ...
        *,
        ...
        try:
            with self.connection.cursor() as cursor:
                ...
                raw_session_token = f"geno-session-{secrets.token_urlsafe(32)}"
    ...
    with connection.cursor() as cursor:
        cursor.execute(
            ...
            SELECT
              ...
              set_config('geno.runtime_project_access_control', '1', false),
              set_config('geno.runtime_actor_id', '', false),
              set_config('geno.runtime_project_id', '', false),
              set_config('geno.runtime_tenant_id', '', false),
              set_config('geno.runtime_invitation_token_hash', '', false),
              set_config('geno.runtime_idempotency_key_hash', '', false),
              set_config('geno.runtime_requested_surface', '', false),
              set_config('geno.runtime_portal_token_hash', '', false),
              set_config('geno.runtime_session_token_hash', '', false)
            """
        )
    connection.commit()
