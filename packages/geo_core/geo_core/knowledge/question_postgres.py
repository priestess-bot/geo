...
from geo_core.knowledge.question_postgres_validation import (
    lock_and_validate_generation_inputs as _lock_and_validate_generation_inputs,
)
        ...
        try:
            ...
            claim = QuestionGenerationClaim(
                ...
                generation_mode=cast(
                    Literal["single_scenario", "coverage_pack"],
