...
from geo_core.models import LLMCallLog
...
class FixtureLLMGateway:
    ...
    def chat(
        ...
        *,
        ...
        call_log = LLMCallLog(
            id=str(uuid5(NAMESPACE_URL, f"geo:llm-call:{self.provider}:{model}:{request_hash}:{response_hash}")),
    ...
    def chat(
        ...
        *,
        ...
        return {
            ...
            "raw_response": {
                **response_payload,
                "_geo_retry": {"attempt_count": attempt_count, "prior_errors": list(prior_errors)},
            },
            "call_log": asdict(call_log),
        }
