"""Core contracts and data models for the GEO AU evidence platform."""
...
from geo_core.email_feedback_signatures import (
...
from geo_core.knowledge_application import (
    ...
    GEO_FAQ_CANDIDATE_PROMPT_VERSION,
    GEO_PROMPT_CANDIDATE_PROMPT_VERSION,
    KNOWLEDGE_APPLICATION_PIPELINE_VERSION,
    KNOWLEDGE_CRAWLER_ADAPTER_VERSION,
...
from geo_core.llm_gateway import FixtureLLMGateway, LiteLLMGateway, LLMGatewayRetryExhaustedError
from geo_core.market import build_au_market_profile
from geo_core.prompt_pack import build_au_dtc_prompt_pack
...
from geo_core.object_store import archive_api_snapshot_assets, archive_browser_capture_assets, archive_project_brand_logo
from geo_core.scoring import (
    AU_VISIBILITY_V1,
    AU_VISIBILITY_V1_1_LOCAL_BOOST,
    RegistryScoringFormula,
    SCORE_FORMULA_REGISTRY,
    SCORE_WEIGHT_PROFILE_REGISTRY,
    ScoreFormulaDefinition,
    ScoreWeightProfileDefinition,
    get_score_formula,
    list_score_formulas,
