...
class RepositoryBoundary:
    ...
    methods: tuple[str, ...]
    scope_required: bool
    compatibility_owner: str = "geo_core.repository.PostgresEvidenceRepository"


AUDIT_REPOSITORY_BOUNDARY = RepositoryBoundary(
    boundary_id="audit",
    module="geo_core.repositories.audit_repository",
...
PROJECT_REPOSITORY_BOUNDARY = RepositoryBoundary(
    boundary_id="project",
    module="geo_core.repositories.project_repository",
...
ACCESS_CONTROL_REPOSITORY_BOUNDARY = RepositoryBoundary(
    ...
    module="geo_core.repositories.access_control_repository",
